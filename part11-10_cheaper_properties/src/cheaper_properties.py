...
def cheaper_properties(properties: list[RealProperty], reference: RealProperty):
    return [(property, property.price_difference(reference)) for property in properties if property.square_meters * property.price_per_sqm < reference.square_meters * reference.price_per_sqm]
